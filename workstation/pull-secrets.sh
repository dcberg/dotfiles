...
export OP_SESSION_my=$(op signin https://my.1password.com danberg@us.ibm.com --output=raw)

echo "Pulling secrets"
# private keys
op get document 'github_rsa' > github_rsa
op get document 'jump2_rsa' > jump2_rsa
...
ln -s $(pwd)/jump2_rsa ~/.ssh/jump2_rsa
